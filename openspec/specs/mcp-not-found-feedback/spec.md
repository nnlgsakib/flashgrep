...
Define a consistent, machine-readable not-found contract for path-aware MCP operations so agents can branch deterministically when files or directories are missing.
