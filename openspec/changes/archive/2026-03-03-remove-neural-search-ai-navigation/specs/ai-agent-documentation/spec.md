...
#### Scenario: Skill doc enforces programmatic-first search ordering
- **WHEN** an agent chooses a search approach for discovery tasks
- **THEN** the guidance MUST direct the agent to lexical/programmatic query behavior first
