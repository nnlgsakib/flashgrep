...
The CLI SHALL provide an indexed text search command for grep-like workflows, SHALL support continuation-aware execution for arbitrarily large logical result sets, and SHALL expose compatibility options required for production script replacement.
